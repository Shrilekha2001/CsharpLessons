...
namespace LessonA.Day4
{
    class Date
    {
        ...
        public static void findageofperson()
        {
            ...
            int month = d1.Month;
            Console.WriteLine("Month OF Dob " + month);
            DateTime d2 = d1.AddMonths(-8);
            Console.WriteLine("AddMonths " + d2.ToShortDateString());
            DateTime d3 = d1.AddDays(-25);
            Console.WriteLine("AddDays " + d3.ToShortDateString());
            DateTime d4 = d1.AddYears(-23);
            Console.WriteLine("AddYears " + d4.ToShortDateString());
            DateTime d5 = d1.AddYears(-5);
            Console.WriteLine("AddYears(-5) " + d5.ToShortDateString());
        ...
        public static void retairmentdate()
        {
            ...
            int day = d1.Day;
            Console.WriteLine("Day OF Dob " + day);
            DateTime d5 = d1.AddYears(+60);
            Console.WriteLine("AddYears" + d5.ToShortDateString());
            DateTime d3 = d1.AddDays(+31);
            Console.WriteLine("AddDays " + d3.ToShortDateString());
